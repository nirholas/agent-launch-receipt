...
Create a human-readable receipt for agent deployment, authorities, and endpoints.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Agent Launch Receipt explores a focused consumer use of that space while making the wire budget visible.
